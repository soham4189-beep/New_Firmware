...
- pin_list:
  ...
  - {pin_num: '48', peripheral: PORTB, signal: 'port, 2', pin_signal: PTB2, direction: OUTPUT}
  ...
  - {pin_num: '18', peripheral: PORTE, signal: 'port, 3', pin_signal: PTE3, direction: INPUT}
  ...
  - {pin_num: '52', peripheral: PORTC, signal: 'port, 10', pin_signal: PTC10, direction: INPUT}
  ...
  - {pin_num: '20', peripheral: PORTD, signal: 'port, 17', pin_signal: PTD17, direction: INPUT}
